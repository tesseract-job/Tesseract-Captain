...
@ApiModel(value="TesseractCaptainEntityRelation对象", description="")
public class TesseractCaptainEntityRelation implements Serializable {
    ...
    @ApiModelProperty(value = "关系类型:一对多，一对一，多对多")
